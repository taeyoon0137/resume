...
import {
  ...
  img_project_thumbnail_vendit_at_gangnam,
  img_project_thumbnail_vendit_brochure,
  img_project_thumbnail_vendit_icon,
  img_project_thumbnail_vendit_ir,
  img_project_thumbnail_vendit_landing,
  img_project_thumbnail_vendit_vds,
  img_project_thumbnail_vendit_vkiosk,
  img_project_thumbnail_vendit_vpms,
...
export const contentData: ContentData = {
  ...
  projects: [
    {
      project: "VPMS – 숙박업의 미래",
      roles: ["Product Designer"],
      thumbnail: img_project_thumbnail_vendit_vpms,
      organization: "주식회사 벤디트",
      link: "https://www.vendit.co.kr/vpms",
      techStacks: ["Figma", "Lottie", "Amplitude"],
      content: {
        summary: [
          "다양한 고객층이 이용할 수 있는 호텔 PMS 기획",
    ...
    {
      project: "VKIOSK – 누구나 사용 가능한 첫 키오스크",
      roles: ["Product Designer"],
      thumbnail: img_project_thumbnail_vendit_vkiosk,
      organization: "주식회사 벤디트",
      link: "https://www.vendit.co.kr/kiosk",
      techStacks: ["Figma", "Lottie", "Amplitude"],
      content: {
        summary: [
          "폭넓은 연령층 이용 및 장애 접근성 대응이 가능한 체크인 키오스크 기획",
    ...
    {
      project: "Vendit Design System",
      roles: ["Product Designer"],
      thumbnail: img_project_thumbnail_vendit_vds,
      organization: "주식회사 벤디트",
      techStacks: ["Figma", "After Effects", "TypeScript", "React", "Tailwind"],
      content: {
        summary: [
          "브랜드 리소스를 일원화, 누적된 요구사항을 반영하여 리뉴얼",
    ...
    {
      project: "Vendit Icon Glyph",
      roles: ["Product Designer"],
      thumbnail: img_project_thumbnail_vendit_icon,
      organization: "주식회사 벤디트",
      techStacks: ["Figma", "TypeScript"],
      content: {
        summary: [
          "그래픽 아이콘 약 500여 개를 신규 디자인",
    ...
    {
      project: "Vendit Landing",
      roles: ["Product Designer", "FE Engineer"],
      thumbnail: img_project_thumbnail_vendit_landing,
      link: "https://www.vendit.co.kr",
      organization: "주식회사 벤디트",
      techStacks: ["Figma", "Lighthouse", "SEO", "Amplitude", "TypeScript", "WordPress", "PHP"],
      content: {
        summary: [
          "영업 및 마케팅의 유연한 대응을 위한 워드프레스 기반 홈페이지 제작",
    ...
    },
    {
      project: "Vendit IR",
      roles: ["Product Designer"],
      thumbnail: img_project_thumbnail_vendit_ir,
      organization: "주식회사 벤디트",
      techStacks: ["Figma"],
      content: {
        summary: [
          "시리즈 A 투자 유치를 위한 IR 프레젠테이션 제작",
    ...
    {
      project: "Vendit Product Brochure",
      roles: ["Product Designer"],
      thumbnail: img_project_thumbnail_vendit_brochure,
      link: "https://www.vendit.co.kr/n/product-brochure",
      organization: "주식회사 벤디트",
      techStacks: ["Figma", "InDesign", "Illustrator"],
      content: {
        summary: ["자사 제공 제품 안내를 위한 브로슈어 제작 및 발주", "약 3,000부 발주 및 배부"],
      },
      startYear: 2025,
      startMonth: 6,
      endYear: 2025,
    ...
    {
      project: "Hotel At Gangnam 사이니지",
      roles: ["Product Designer"],
      thumbnail: img_project_thumbnail_vendit_at_gangnam,
      link: "https://hotelat.com/",
      organization: "주식회사 벤디트",
      techStacks: ["Figma", "Illustrator"],
      content: {
        summary: [
          "자사 운영 캡슐 호텔 사이니지 제작",
    ...
    },
    {
      ...
      organization: "주식회사 왓섭",
      techStacks: ["Figma", "Lottie", "After Effects", "TypeScript", "React", "React Native"],
      content: {
        summary: [
          "설계부터 개발까지 단독 진행",
          ...
          "Lottie의 구조를 변형하여 자체 *.lottie.json 포맷 제작 및 리소스 오버라이드 추가",
        ],
      },
      startYear: 2021,
      startMonth: 2,
    ...
    },
    {
      ...
      link: "https://whatssub.co",
      organization: "주식회사 왓섭",
      techStacks: ["Figma", "Lottie", "Amplitude", "Plaid", "After Effects", "Photoshop", "Illustrator", "Hackle"],
      content: {
        summary: [
